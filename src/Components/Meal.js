    ...
    render(){
        return (
            <div>
                ...
                <button onClick={() => this.props.deleteMeal(this.props.meal.id, this.props.meal.category)}>Delete</button>
            </div>
        )
...
export default connect(mapStatetoProps, {updateForm})(withRouter(Meal))